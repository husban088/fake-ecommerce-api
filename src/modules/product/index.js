...
const Product = () => {
    ...
    return (
        <section className="prod__mod text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img 
              ...
              src={product?.image} 
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 product__ddetails-two">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="product__btns">
                  {/* <button 
                    className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded mr-2 product__btn"
